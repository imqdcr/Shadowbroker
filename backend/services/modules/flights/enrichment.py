"""
enrichment.py — Aircraft enrichment from Plane-Alert DB and tracked names.
"""
...
_DATA_DIR = Path(__file__).parent.parent.parent.parent / "data"  # backend/data/

# ---------------------------------------------------------------------------
# Category → color mapping
# ---------------------------------------------------------------------------
_CATEGORY_COLOR: dict = {
    "USAF": "yellow", "Other Air Forces": "yellow", "Toy Soldiers": "yellow",
    "Oxcart": "yellow", "United States Navy": "yellow", "GAF": "yellow",
    "Hired Gun": "yellow", "United States Marine Corps": "yellow", "Gunship": "yellow",
    "RAF": "yellow", "Other Navies": "yellow", "Special Forces": "yellow",
    "Zoomies": "yellow", "Royal Navy Fleet Air Arm": "yellow", "Army Air Corps": "yellow",
    "Aerobatic Teams": "yellow", "UAV": "yellow", "Ukraine": "yellow", "Nuclear": "yellow",
    "Flying Doctors": "#32cd32", "Aerial Firefighter": "#32cd32", "Coastguard": "#32cd32",
    "Police Forces": "blue", "Governments": "blue", "Quango": "blue",
    "UK National Police Air Service": "blue", "CAP": "blue",
    "PIA": "black",
    "Dictator Alert": "red", "Da Comrade": "red", "Oligarch": "red",
    "Head of State": "#ff1493", "Royal Aircraft": "#ff1493",
    "Don't you know who I am?": "#ff1493", "As Seen on TV": "#ff1493",
    "Bizjets": "#ff1493", "Vanity Plate": "#ff1493", "Football": "#ff1493",
    "Joe Cool": "orange",
    "Climate Crisis": "white",
    "Historic": "purple", "Jump Johnny Jump": "purple", "Ptolemy would be proud": "purple",
    "Distinctive": "purple", "Dogs with Jobs": "purple",
    "You came here in that thing?": "purple", "Big Hello": "purple",
    "Watch Me Fly": "purple", "Perfectly Serviceable Aircraft": "purple",
    "Jesus he Knows me": "purple", "Gas Bags": "purple", "Radiohead": "purple",
}
...
def _load_plane_alert_db():
    ...
    json_path = _DATA_DIR / "plane_alert_db.json"
    ...
    try:
        ...
        for icao_hex, info in raw.items():
            info["color"] = _CATEGORY_COLOR.get(info.get("category", ""), "purple")
...
def _load_tracked_names():
    ...
    json_path = _DATA_DIR / "tracked_names.json"
    if not json_path.exists():
        return
    try:
